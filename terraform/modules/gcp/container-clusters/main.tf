module "container-clusters" {
  ...
  source                                = "git::git@github.com:terraform-google-modules/terraform-google-kubernetes-engine.git//modules/beta-private-cluster?ref=v14.0.0"
...
module "container-cluster-auths" {
  ...
  source       = "git::git@github.com:terraform-google-modules/terraform-google-kubernetes-engine.git//modules/auth?ref=v14.0.0"
  project_id   = each.value["project_id"]
